...
MAINTAINER Islam Abdelaziz <islamabdelaziz450@gmail.com>
...
- docker build -t iabdelaziz/newchallenge .  && docker push aymanbehery/newunicorn
```
...
> In your Deployemnt use your image name , but you can use my image to test the deployment : iabdelaziz/newchallenge:latest
```yaml
---
apiVersion: extensions/v1beta1
kind: Deployment
